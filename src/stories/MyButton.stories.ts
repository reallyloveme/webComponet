...
const wrapStory = (content: unknown) => html`
  <div
    style="width:480px; aspect-ratio:4 / 3; display:flex; align-items:center; justify-content:center; padding:16px; box-sizing:border-box;"
  >
    ${content}
  </div>
`;
